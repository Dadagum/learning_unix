...
#define ADDRSTRLEN (NI_MAXHOST + NI_MAXSERV + 10)
 ...
 that can be used to successfully create and bind a socket */
    ...
    for (rp = result; rp != NULL; rp = rp->ai_next)
    {
        ...
        // 书本原话：Set the SO_REUSEADDR option for the socket created in the previous step y. 
        // We defer discussion of this option until Section 61.10, where we note that 
        // a TCP server should usually set this option on its listening socket.
